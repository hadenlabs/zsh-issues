<!-- Space: Projects -->
<!-- Parent: ZshIssues -->
<!-- Title: Contributing GithubFlow ZshIssues -->
<!-- Label: ZshIssues -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-issues project on [GitHub](https://github.com/hadenlabs/zsh-issues), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-issues/pulls).
...
To follow the instructions in this guide and start contributing to zsh-issues project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/zsh-issues.git
```

Now your **upstream** points to **hadenlabs/zsh-issues**.
...
git fetch upstream # assuming upstream is hadenlabs/zsh-issues
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/zsh-issues/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
