...
:Download: https://github.com/luismayta/zsh-issues
:Source: https://github.com/luismayta/zsh-issues
:Keywords: zsh-issues
...
2. Clone the plugin
    ``bash   git clone https://github.com/luismayta/zsh-issues``\ bash
3. Edit your ``.zshrc`` and add
    ``plugins=( ... zsh-issues )`` to your list of
    plugins
...
1. Add :
    ...
    .. code-block:: bash
        ...
        antibody bundle luismayta/zsh-issues

    to your ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
    run ``antibody bundle luismayta/zsh-issues`` in a
    running zsh session.
3. Enjoy!
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-issues.svg
    :target: https://travis-ci.org/luismayta/zsh-issues
.. |GitHub issues| image:: https://img.shields.io/github/issues/luismayta/zsh-issues.svg
    :target: https://github.com/luismayta/zsh-issues/issues
